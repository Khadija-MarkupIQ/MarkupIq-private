...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="bg-gradient-to-br from-sky-50 via-gray-50 to-slate-100 text-gray-800 pt-16 pb-8"
    >
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 text-lg leading-relaxed max-w-md">
              Transform your redline workflow with AI-powered precision. Faster
              handovers, fewer errors, and higher productivity for AEC teams.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-600 hover:text-gray-900 transition-colors">
                ...
                <a
                  href="mailto:sales@redlineiq.com"
          ...
          <div>
            ...
            <a
              href="#contact-form"
              className="block w-full text-center py-3 bg-gradient-to-r from-blue-500 to-slate-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-0.5"
            >
              Contact Sales
            </a>
          </div>

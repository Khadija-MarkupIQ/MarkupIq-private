...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-sky-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
        {/* Badge */}
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 border border-blue-200 mb-6 md:mb-8">
      ...
      productivity for architects, engineers, and contractors.
        ...
        {/* CTA Buttons */}
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 px-4">
      <a
        href="#contact-form"
        className="group inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-2xl sm:rounded-3xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold shadow-lg hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-1"
      >
        Start Free Trial
        <svg
      ...
      <a
        href="#features"
        className="group inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-2xl sm:rounded-3xl border-2 border-gray-200 text-gray-700 font-semibold hover:border-blue-400 hover:bg-white/60 transition-all duration-300"
      >
        <svg
    ...
    {/* Stats Section */}
    <div className="mt-16 sm:mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-3xl mx-auto px-4">
      {[
        ...
        >
          <div className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900">{stat.number}</div>
  ...
  <div className="absolute -bottom-44 -left-24 w-72 h-72 sm:w-96 sm:h-96 bg-purple-400/20 blur-3xl rounded-full"></div>
  <div className="absolute -top-44 -right-24 w-72 h-72 sm:w-96 sm:h-96 bg-blue-400/20 blur-3xl rounded-full"></div>
</section>
  );
}
